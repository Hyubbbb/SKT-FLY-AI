...
h, w = image1.shape[:2]
cx, cy = w//2, h//2 # 중심 좌표
cv2.circle(image1, (cx, cy), 100, 255, -1) # 흰색 원 그리기
cv2.rectangle(image2, (0, 0, cx, h), 255, -1) # 영상의 가로 절반

image3 = cv2.bitwise_or(image1, image2)  # 논리합
image4 = cv2.bitwise_and(image1, image2) # AND
image5 = cv2.bitwise_xor(image1, image2) # XOR
image6 = cv2.bitwise_not(image1)         # NOT
